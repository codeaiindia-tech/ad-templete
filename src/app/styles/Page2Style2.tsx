            ...
            <div className='h-screen w-full bg-white flex flex-col' >
                <div className='w-full h-1/2 flex justify-center items-center'>
                    <div className='w-[45%] h-full flex justify-center items-center' >
                        <h1 className='text-6xl text-black font-sans'>*RANDOM TEXTS*</h1>
                    </div>
                ...
                <div className='w-full h-1/2 bg-gray-100 pt-10 flex flex-col '>
                    <div className='w-full flex justify-center items-center  pt-6'>
                        <div className=' w-[20vw] h-[7vw] p-4   border-r-2 border-gray-400  flex justify-center items-center'>
                            <h1 className='text-black font-semibold font-sans text-2xl text-center'>3.5 BHK - <br /> 2458 SQ.FT. </h1>
                        </div>
                        <div className=' w-[20vw] h-[7vw] p-4   border-r-2 border-gray-400  flex justify-center items-center'>
                            <h1 className='text-black font-semibold font-sans text-2xl text-center'>4.5 BHK - <br /> 3632 SQ.FT. </h1>
                        </div>
                        <div className=' w-[20vw] h-[7vw] p-4   border-r-2 border-gray-400  flex justify-center items-center px-5'>
                            <h1 className='text-black font-semibold font-sans text-2xl text-center'>Golf View with 180° clear view</h1>
                        </div>
                        <div className=' w-[20vw] h-[7vw] p-4   flex justify-center items-center px-8'>
                            <h1 className='text-black font-semibold font-sans text-2xl text-center'>8-Feet long Jacuzzi Balcony</h1>
                        </div>
                    </div>
